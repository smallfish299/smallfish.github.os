...
def classify_category(row):
    if row[2].startswith('11') and '北京' in row[3]:
        return '北京'
    elif row[2].startswith('12') and '天津' in row[3]:
        return '天津'
    elif row[2].startswith('13') and '广东' in row[3]:
        return '广东'
    elif row[2].startswith('71') and '安徽' in row[3]:
        return '安徽'
    else:
        return '其他'
