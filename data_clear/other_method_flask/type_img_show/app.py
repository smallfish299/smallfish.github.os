...
def pie_chart():
    ...
    category_counts = {}
    for row in data:
        category = classify_category(row[2])
    ...
    # 将分类数据和原始数据写入文件
    write_to_file(data, category_counts)
    ...
    return render_template('category.html', img_path=img_path)

def write_to_file(data, category_counts):
